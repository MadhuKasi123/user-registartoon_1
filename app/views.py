...
def registration(request):
    ...
    if request.method=='POST' and request.FILES:
        ...
        if ufd.is_valid() and pfd.is_valid():
            ...
            'registartion succesfully',
            'madhhkaasi143@gmail.com',
...
def change_passward(request):
    if request.method=='POST':
        ...
        UO.set_password(pw)
        UO.save()
        return HttpResponse('password succefully changed')
    return render (request,'change_passward.html')
